...
func ConnectServerByProxyWithTLS(proxyURL string, protocol string, addr string, tlsConfig *tls.Config, tlsWrap bool) (c net.Conn, err error) {
	...
	c = MakeTLSClientConn(c, tlsConfig, tlsWrap)
	return
}
